...
const saveButtonForPicProfile = changeProfileImgPopup.querySelector('.popup__save-button')
const saveBtnForAddCard = popupTypeAddCard.querySelector('.popup__save-button');
const saveBtnForEditProfile = popupTypeEditProfile.querySelector('.popup__save-button')
